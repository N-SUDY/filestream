...
from Savory.bot.plugins.stream import MY_PASS
from Savory.utils.human_readable import humanbytes
from Savory.utils.database import Database
from pyrogram import filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton
from pyrogram.errors import UserNotParticipant
from Savory.utils.file_properties import get_name, get_hash, get_media_file_size
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="t.me/savoryrabbit")],
                [InlineKeyboardButton("💥 Support Us", url="t.me/savorybotzz")]
            ]
        )
    )
